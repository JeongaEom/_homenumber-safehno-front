...
const serverAssets = [{"baseName":"server","dir":"C:/Workspace/GitLab/homenumber-safehno-front/node/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Workspace\\GitLab\\homenumber-safehno-front\\node","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Workspace\\GitLab\\homenumber-safehno-front\\node\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Workspace\\GitLab\\homenumber-safehno-front\\node\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Workspace\\GitLab\\homenumber-safehno-front\\node\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Workspace\\GitLab\\homenumber-safehno-front\\node\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "C:/Workspace/GitLab/homenumber-safehno-front/node";
...
const getClientManifest = () => import('file://C:/Workspace/GitLab/homenumber-safehno-front/node/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Workspace/GitLab/homenumber-safehno-front/node/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
