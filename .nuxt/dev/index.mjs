...
const _9Vlz1RSVI2 = (function(nitro) {
...
const _lazy_5jJ6Jg = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_5jJ6Jg, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_5jJ6Jg, lazy: true, middleware: false, method: undefined }
];
