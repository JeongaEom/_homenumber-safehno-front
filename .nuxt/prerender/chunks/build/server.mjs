import { version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, h, inject, computed, unref, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, mergeProps, createApp, effectScope, reactive, markRaw, isRef, isReactive, toRef, toRaw, useSSRContext, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, toRefs, isShallow, withCtx, defineAsyncComponent } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/ofetch/dist/node.mjs';
...
import { sanitizeStatusCode, createError as createError$1 } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/vue-router/dist/vue-router.node.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isSamePath } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/ufo/dist/index.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file://C:/Workspace/GitLab/homenumber-safehno-front/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: (__nuxt_page_meta$b == null ? void 0 : __nuxt_page_meta$b.name) ?? "error",
    path: (__nuxt_page_meta$b == null ? void 0 : __nuxt_page_meta$b.path) ?? "/error",
    ...
    component: () => import('./index-lqAwZR9S.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$a == null ? void 0 : __nuxt_page_meta$a.name) ?? "homenumberInquiry",
    path: (__nuxt_page_meta$a == null ? void 0 : __nuxt_page_meta$a.path) ?? "/homenumberInquiry",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$9 == null ? void 0 : __nuxt_page_meta$9.path) ?? "/homenumberList",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.path) ?? "/issuance",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.path) ?? "/modification",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/personalInformation",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/serviceInfo",
    meta: __nuxt_page_meta$3 || {},
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: __nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect,
    component: () => import('./index-kajkr5v-.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/test_list",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/test1",
...
const layouts = {
  "default-none": () => import('./default-none-DZvQgSGl.mjs').then((m) => m.default || m),
  default: () => import('./default-C1RZ--yv.mjs').then((m) => m.default || m),
  login: () => import('./login-DVR-VBjC.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D5VGT4YI.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CMUBYsd5.mjs').then((r) => r.default || r));
...
export { useRouter as a, useRuntimeConfig as b, navigateTo as c, defineStore as d, entry$1 as default, nuxtLinkDefaults as n, useHead as u };
